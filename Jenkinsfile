  ...
  stages {
    stage("Test") {
      steps {
        ...
        locust -f /home/dima/agent/workspace/obmc_webui/tests/locustfile.py --headless --users 60 --spawn-rate 30 --run-time 10s --stop-timeout 20s --host https://127.0.0.1:2443 --html /home/dima/agent/workspace/obmc_webui/reports/obmc_load.html
        '''
